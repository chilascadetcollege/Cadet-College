...
const translations = {
    ...
    ur: {
        ...
        hero_desc: "مستقبل کے معماروں کی تشکیل۔ ہم 125 ایکڑ کے وسیع کیمپس میں جسمانی اور ذہنی نشوونما کے ذریعے معیاری تعلیم اور شخصیت سازی پر توجہ دیتے ہیں۔",
        ...
        scroll_down: "نیچے اسکرول کریں",
        about_subtitle: "ہمارا کیمپس",
        about_title: "شاندار <span class class='accent-text'>روایات</span>",
        about_p1: "کیمپس <strong>125 ایکڑ</strong> کے رقبے پر پھیلا ہوا ہے۔ اس وسیع رقبے میں ایک جدید ترین انتظامی اور اکیڈمک بلاک شامل ہے، جو تعلیم کے لیے بہترین ماحول فراہم کرتا ہے۔",
        about_p2: "کیڈٹس کی مجموعی گرومنگ کیڈٹ کالج کا طرہ امتیاز ہے۔ اس لیے، نئے کیمپس میں ذہنی نشوونما کے ساتھ ساتھ جسمانی نشوونما کو بھی خاص اہمیت دی گئی ہے۔",
        ...
        mission_text: "کیڈٹ کالج دیامر کا مشن معیاری تعلیم، شخصیت کی نشوونما کو فروغ دینا ہے۔",
        faculty_subtitle: "ہماری ٹیم",
        faculty_title: "ہمارے قابلِ فخر <span class='accent-text'>اساتذہ</span>",
...
const facultyData = [
    ...
    {
        name: { en: "Mr. Akhtar Rehman", ur: "اختر الرحمان" },
    ...
    },
    {
        ...
        role: { en: "Lecturer In Biology", ur: "لیکچرر (بیالوجی)" },
        desc: { en: "M.Phil in wild life ecology From Qaid-i- Azam University Islamabad, Bs hons zoology from KIU", ur: "ایم فل وائلڈ لائف ایکولوجی قائد اعظم یونیورسٹی، بی ایس زولوجی" },
    ...
    },
    {
        ...
        role: { en: "Lecturer In Urdu", ur: "لیکچرر (اردو)" },
        desc: { en: "M.Phil Urdu From KIU GILGIT, B.Ed from VU Lahore", ur: "ایم فل اردو قراقرم انٹرنیشنل یونیورسٹی، بی ایڈ ورچوئل یونیورسٹی لاہور" },
    ...
    },
    {
        ...
        role: { en: "Lecturer In chemistry", ur: "لیکچرر (کیمسٹری)" },
        desc: { en: "Bs Chemistry From Abbottabad University, B.Ed from Sarhad University Peshawar", ur: "بی ایس کیمسٹری ایبٹ آباد یونیورسٹی، بی ایڈ سرحد یونیورسٹی پشاور" },
    ...
    },
    {
        ...
        role: { en: "Lecturer of Biology", ur: "لیکچرر (بیالوجی)" },
    ...
    },
    {
        ...
        desc: { en: "Phd Scholar (University of Peshawar), MS in Mathematics from Qurtuba University Peshawar. M.Ed From University of Swabi.", ur: "پی ایچ ڈی سکالر پشاور یونیورسٹی، ایم ایس ریاضی قرطبہ یونیورسٹی پشاور" },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const setLanguage = (lang) => {
        ...
        if (lang === 'ur') {
            ...
            document.getElementById('lang-text').innerText = 'اردو';
        }
